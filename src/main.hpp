...
const unsigned int left_front_corner_sensor_pin = A0;
const unsigned int right_front_corner_sensor_pin = A1;
const unsigned int left_rear_corner_sensor_pin  = A2;
const unsigned int Right_rear_corner_sensor_pin = A3;
const unsigned int battery_voltage_pin = A4;
const unsigned int battery_current_pin = A5;
...
/* Other variables */
volatile long int left_encoder_position = 0;
volatile long int right_encoder_position = 0;
...
/* PID variables */
double leftInput, leftOutput, leftSetpoint = 0.0,
       rightInput, rightOutput, rightSetpoint = 0.0;

const float KpL = 1, KiL = 0, KdL = 0;
const float KpR = 1, KiR = 0, KdR = 0;
