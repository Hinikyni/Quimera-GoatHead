#ifndef _ROS_cob_pick_place_action_CobPickFeedback_h
#define _ROS_cob_pick_place_action_CobPickFeedback_h
...
namespace cob_pick_place_action
{
  ...
  class CobPickFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "cob_pick_place_action/CobPickFeedback"; };
