#ifndef _ROS_SERVICE_Script_h
#define _ROS_SERVICE_Script_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SCRIPT[] = "cob_android_msgs/Script";

  class ScriptRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SCRIPT; };
    const char * getMD5(){ return "0a40a194b72e6783b1b8bec8d1c28c7f"; };

  };

  class ScriptResponse : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SCRIPT; };
    const char * getMD5(){ return "ea324a22c787839f822b9a025bc2c6fe"; };

  };

  class Script {
    public:
    typedef ScriptRequest Request;
    typedef ScriptResponse Response;
  };
