#ifndef _ROS_SERVICE_MultiplieTwoInts_h
#define _ROS_SERVICE_MultiplieTwoInts_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char MULTIPLIETWOINTS[] = "pubsub/MultiplieTwoInts";

  class MultiplieTwoIntsRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return MULTIPLIETWOINTS; };
    const char * getMD5(){ return "c8559b52d432bccd240703f31aeca517"; };

  };

  class MultiplieTwoIntsResponse : public ros::Msg
  {
    public:
      typedef int64_t _sum_type;
      _sum_type sum;

    MultiplieTwoIntsResponse():
      sum(0)
    {
    }
  ...
  class MultiplieTwoInts {
    public:
    typedef MultiplieTwoIntsRequest Request;
    typedef MultiplieTwoIntsResponse Response;
  };
