...
static const char INITFINGER[] = "cob_hand_bridge/InitFinger";
  ...
  class InitFingerRequest : public ros::Msg
  {
    public:
      ...
      _port_type port;
      typedef int16_t _min_pwm0_type;
      _min_pwm0_type min_pwm0;
      typedef int16_t _min_pwm1_type;
      _min_pwm1_type min_pwm1;
      typedef int16_t _max_pwm0_type;
      _max_pwm0_type max_pwm0;
      typedef int16_t _max_pwm1_type;
      _max_pwm1_type max_pwm1;
